...
namespace TouchScreenKeyboard.Controls
{
    public partial class FloatingTouchScreenKeyboard
    {
        ...
        public static  DependencyProperty IsShowProperty = DependencyProperty.Register("IsShow", typeof(Visibility), typeof(FloatingTouchScreenKeyboard), new UIPropertyMetadata(Visibility.Visible));
